-- SQL Migration: Add manual Free Tier toggle for Owners
ALTER TABLE public.owners ADD COLUMN IF NOT EXISTS free_tier_enabled BOOLEAN DEFAULT FALSE;

-- Update the get_owner_dashboard_data RPC to return this field
...
DECLARE
  ...
  v_owner_meta JSON;
BEGIN
  -- 0. Get owner metadata (Including new free_tier_enabled flag)
  ...
  RETURN json_build_object(
    'owner', COALESCE(v_owner_meta, json_build_object('free_tier_enabled', false)),
