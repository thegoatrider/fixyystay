    ...
    <div className="min-h-screen bg-gray-50 py-20 px-4">
      ...
      <div className="max-w-6xl mx-auto text-center mb-16">
        ...
        <p className="text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed">
          List your properties, manage leads, and grow with the most advanced property management tool for North India.
        </p>
      </div>
      ...
      <div className="max-w-sm mx-auto mb-16 px-4">
        ...
        />
        <p className="text-[10px] text-gray-400 mt-2 text-center">We will use this email to create your admin account.</p>
      </div>
      ...
      <div className="mt-20 text-center text-gray-400 text-sm max-w-xl mx-auto">
        ...
        <p className="mt-2 font-bold text-gray-500">Need help? WhatsApp: +91 91234 56789</p>
      </div>
    </div>
  )
}
